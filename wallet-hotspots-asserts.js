	...
	try {
		...
		if (account) {
            ...
            for (const hotspot of hotspots.data) {
                ...
                // 'payment_v1','payment_v2','add_gateway_v1','rewards_v1','rewards_v2','poc_receipts_v1','transfer_hotspot_v1','assert_location_v1','assert_location_v2','token_burn_v1','unstake_validator_v1','stake_validator_v1','transfer_validator_stake_v1'
                ...
                const transactions = await hotspot.activity.list({
                    filterTypes: ['assert_location_v1', 'assert_location_v2']
                });
                ...
                try {
                    ...
                    fs.appendFileSync(fileStream, "Time,Height,Lat,Lng,Location,Owner,Gateway,Type,Hash\n");
                    ...
                    do {
                        ...
                        for (const transaction of transactionsPage) {
                            ...
                            outCSV = transactionTime.toISOString() + "," +
                                    transaction.height + "," +
                                    transaction.lat + "," +
                                    transaction.lng + "," +
